...
class composition_speech_multihead_attention(nn.Module):
    ...
    def forward(self, speechs_combined: torch.Tensor, masks: torch.Tensor):
        query = speechs_combined
        key = speechs_combined
        value = speechs_combined
